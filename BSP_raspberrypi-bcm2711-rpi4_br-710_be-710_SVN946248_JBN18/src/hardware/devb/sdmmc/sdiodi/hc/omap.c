...
#ifdef SDIO_OMAP_BUS_SYNC
static int omap_so_init( sdio_hc_t *hc )
{
	int 			fd;
	int 			r = EOK;
	char 			name[128];
...
static int omap_so_dinit( sdio_hc_t *hc )
{
	omap_hc_mmchs_t		*mmchs = (omap_hc_mmchs_t *)hc->cs_hdl;
...
static void omap_bus_sync( sdio_hc_t *hc )
{
	omap_hc_mmchs_t		*mmchs = (omap_hc_mmchs_t *)hc->cs_hdl;
	/*
...
static const struct sigevent *omap_sdma_intr( void *hdl, int id )
{
	sdio_hc_t			*hc;
	omap_hc_mmchs_t		*mmchs;
	uintptr_t			cbase;
...
static int omap_sdma_event( sdio_hc_t *hc )
{
	omap_hc_mmchs_t		*mmchs;
	sdio_cmd_t			*cmd;
...
static int omap_sdma_init( sdio_hc_t *hc )
{
	omap_hc_mmchs_t		*mmchs;
    rsrc_request_t		req;
...
static int omap_sdma_dinit( sdio_hc_t *hc )
{
	omap_hc_mmchs_t		*mmchs;
    rsrc_request_t		req;
...
static int omap_dma_init(sdio_hc_t *hc)
{
	omap_hc_mmchs_t *mmchs = (omap_hc_mmchs_t *)hc->cs_hdl;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/devb/sdmmc/sdiodi/hc/omap.c $ $Rev: 896546 $")
#endif
