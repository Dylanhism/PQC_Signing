...
int _spi_lock_dev(resmgr_context_t *ctp, uint32_t device, spi_ocb_t *ocb);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/spi/master/proto.h $ $Rev: 933874 $")
#endif
