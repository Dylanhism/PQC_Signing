...
/*
 *  Crypto Assurance and Accelerator Module (CAAM)
 */
#define IMX_CAAM_BASE                          0x31400000
#define IMX_CAAM_SIZE                          0x400000

#define IMX_CAAM_JR0_DONE_IRQ                  483
#define IMX_CAAM_JR1_DONE_IRQ                  484
#define IMX_CAAM_JR2_DONE_IRQ                  485
#define IMX_CAAM_JR3_DONE_IRQ                  486
...
#define IMX_USB2HSIC_BASE                       0x5B0E0000
...
#ifdef __ASM__
__SRCVERSION "$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/public/aarch64/mx8m.h $ $Rev: 935281 $"
#else
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/public/aarch64/mx8m.h $ $Rev: 935281 $" )
#endif
#endif
