...
#define IMX_ACM_ESAI1_MCLK_CTL                           0x070000
...
#define IMX_ACM_HDMI_RX_SAI0_MCLK_CTL                    0x120000
#define IMX_ACM_HDMI_TX_SAI0_MCLK_CTL                    0x130000
#define IMX_ACM_SAI6_MCLK_CTL                            0x140000
#define IMX_ACM_SAI7_MCLK_CTL                            0x150000
#if IMX_ACM_TSAI_FEATURE
    #define IMX_ACM_TSAI0_MCLK_CTL                       0x160000
    #define IMX_ACM_TSAI1_MCLK_CTL                       0x170000
    #define IMX_ACM_TSAI2_MCLK_CTL                       0x180000
    #define IMX_ACM_TSAI3_MCLK_CTL                       0x190000
#endif
#define IMX_ACM_SPDIF0_TX_CLK_CTL                        0x1A0000
#define IMX_ACM_SPDIF1_TX_CLK_CTL                        0x1B0000
...
typedef enum _acm_aud_clk_mux {
    ...
    aud_mux_mlb_clk      = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                 /**< Media Local Bus clock */
    aud_mux_hdmi_rx_mclk,                                                                 /**< HDMI Receiver MCLK audio clock */
    ...
    aud_mux_esai1_rx_clk,                                                                 /**< ESAI1 Receiver external serial bit clock */
    aud_mux_esai1_rx_hf_clk,                                                              /**< ESAI1 Receiver external high frequency clock */
    aud_mux_esai1_tx_clk,                                                                 /**< ESAI1 Transmitter external serial bit clock */
    aud_mux_esai1_tx_hf_clk,                                                              /**< ESAI1 Transmitter external high frequency clock */
    aud_mux_spdif0_rx,                                                                    /**< SPDIF0 Receiver recovered clock */
    aud_mux_spdif1_rx,                                                                    /**< SPDIF1 Receiver recovered clock */
    ...
    aud_mux_hdmi_rx_sai0_rx_bclk                                                          /**< HDMI_RX SAI0 Receiver external serial bit clock (HDMI Rx) */
...
typedef enum _acm_mclk_mux {
    ...
    mclk_mux_mlb_clk = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                     /**< Media Local Bus clock */
    mclk_mux_hdmi_rx_mclk,                                                                /**< HDMI Receiver MCLK audio clock */
    mclk_mux_spdif0_rx,                                                                   /**< SPDIF0 Receiver recovered clock */
    mclk_mux_spdif1_rx,                                                                   /**< SPDIF1 Receiver recovered clock */
    mclk_mux_hdmi_rx_sai0_rx_bclk,                                                        /**< HDMI_RX SAI0 Receiver external serial bit clock (HDMI Rx) */
    mclk_mux_sai6_rx_bclk                                                                 /**< SAI6 Receiver serial bit clock (Audio Mixer) */
} imx_acm_mclk_mux_t;
...
typedef enum _acm_esai_mux {
    ...
    esai_mux_aud_clk0 = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                    /**< Audio Clock Multiplexer 0 output */
    esai_mux_aud_clk1                                                                     /**< Audio Clock Multiplexer 1 output */
} imx_acm_esai_mux_t;

typedef enum _acm_asrc0_presel {
    asrc0_presel_hdmi_rx_sai0_rx_bclk = IMX_ACM_MUX_INIT(0, IMX_ACM_MUX_RESC_MASK, 0),   /**< HDMI_RX_SAI0 Receiver serial bit clock (HDMI Rx) */
    asrc0_presel_hdmi_tx_sai0_tx_bclk,                                                   /**< HDMI_TX_SAI0 Transmitter serial bit clock (HDMI Tx) */
    asrc0_presel_reserved,                                                               /**< Reserved */
    asrc0_presel_mlb_clk                                                                 /**< Media Local Bus clock */
} imx_acm_asrc0_presel_t;
...
typedef enum _acm_sai_mux {
    ...
    sai_mux_aud_clk0 = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                    /**< Audio Clock Multiplexer 0 output */
...
typedef enum _acm_spdif_mux {
    ...
    spdif_mux_aud_clk0 = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                  /**< Audio Clock Multiplexer 0 output */
...
typedef enum _acm_gpt_mux {
    ...
    gpt_mux_aud_clk0 = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                    /**< Audio Clock Multiplexer 0 output */
    gpt_mux_aud_clk1,                                                                    /**< Audio Clock Multiplexer 1 output */
    gpt_mux_ref24m,                                                                      /**< 24 MHz reference */
    gpt_mux_hdmi_rx_mclk                                                                 /**< HDMI RX MCLK */
} imx_acm_gpt_mux_t;
...
typedef enum _acm_mqs_mux {
    ...
    mqs_mux_aud_clk0 = IMX_ACM_MUX_INIT(2, IMX_ACM_MUX_RESC_MASK, 0),                    /**< Audio Clock Multiplexer 0 output */
    mqs_mux_aud_clk1                                                                     /**< Audio Clock Multiplexer 1 output */
} imx_acm_mqs_mux_t;

typedef union _acm_common_mux {
    imx_acm_aud_clk_mux_t   aud;
    imx_acm_mclk_mux_t      mclk;
    imx_acm_esai_mux_t      esai;
    imx_acm_asrc0_presel_t  asrc0;
    imx_acm_sai_mux_t       sai;
    imx_acm_spdif_mux_t     spdif;
    imx_acm_gpt_mux_t       gpt;
    imx_acm_mqs_mux_t       mqs;
} imx_acm_common_mux_t;
#endif /* IMX_ACM_H_ */


#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/public/aarch64/imx8/imx8_acm.h $ $Rev: 842080 $")
#endif
