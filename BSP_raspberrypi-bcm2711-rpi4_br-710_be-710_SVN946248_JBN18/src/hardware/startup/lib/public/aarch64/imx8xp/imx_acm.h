...
typedef enum _acm_aud_clk_mux {
    ...
    aud_mux_ext_aud_mclk0 = IMX_ACM_MUX_INIT(2, SC_R_LAST, 0),                            /**< External MCLK0 audio clock input from IOMUX */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/public/aarch64/imx8xp/imx_acm.h $ $Rev: 934416 $")
#endif
