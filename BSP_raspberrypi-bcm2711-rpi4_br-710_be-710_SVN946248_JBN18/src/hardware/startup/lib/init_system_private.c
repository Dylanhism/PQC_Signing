...
load_bootstraps(struct image_header *ifs_hdr,
	...
	const uint8_t *sig, *m, *pk;
	size_t siglen, mlen;

	mlen = randombytes(m, SPX_MLEN);
...
init_system_private() {
	...
	// Validate image file system signature
	//
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/hardware/startup/lib/init_system_private.c $ $Rev: 892924 $")
#endif
